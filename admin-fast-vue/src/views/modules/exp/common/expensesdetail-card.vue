<template>
  <div style="max-height: 50vh; overflow-y: auto">
    <div v-if="type == 'day'">
      <van-nav-bar v-if="oldType == 'month'" :title="keyword + ' 支出明细'" left-text="返回" left-arrow @click-left="onClickLeft"/>
      <van-nav-bar v-else :title="keyword + ' 支出明细'" />
    ...
    <div v-else>
      <van-nav-bar :title="keyword + ' 支出明细'"/>
